...
// If you want to keep RPC from env, make sure it's NEXT_PUBLIC_ or hard-code
...
export default function WalletInstruction() {
    ...
    const handleAddTokenToMetaMask = async () => {
        ...
        try {
            ...
            if (wasAdded) {
                alert('เพิ่ม RSUToken บนเครือข่าย Sepolia สำเร็จ');
            } else {
